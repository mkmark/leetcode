...
// reference: https://github.com/kth-competitive-programming/kactl/blob/main/content/graph/WeightedMatching.h
// Time: O(n^2 * m)
// Space: O(n + m)
/**
 * @brief calc the minimized cost and corresponding assignment
 * 
 * @param a cost matrix
